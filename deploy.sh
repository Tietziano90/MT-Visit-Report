...
# Step 3.5: Deploy Custom Labels (BEFORE LWCs - LWCs depend on them!)
print_header "STEP 3.5/14: Custom Labels"
print_info "Custom Labels provide translations for UI elements"
