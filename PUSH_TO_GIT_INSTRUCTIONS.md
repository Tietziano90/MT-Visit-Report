...
```
https://github.com/mtietze/MT-Visit-Report
```
...
- Check that the repository exists: https://github.com/mtietze/MT-Visit-Report
...
# Use HTTPS instead
git remote set-url origin https://github.com/mtietze/MT-Visit-Report.git
